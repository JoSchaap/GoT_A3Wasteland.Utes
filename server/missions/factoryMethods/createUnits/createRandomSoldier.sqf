...
_uniformTypes = ["rhs_uniform_cu_ucp","rhs_uniform_cu_ocp_patchless","rhs_uniform_cu_ucp","rhs_uniform_cu_ucp_patchless"];
_vestTypes = ["V_PlateCarrier1_rgr","V_PlateCarrier2_rgr"];
_weaponTypes = ["rhs_m4a1_grip_acog3","rhs_m4a1_grip_acog2","rhs_m4a1_grip_acog"];
